...
全てのエンジニアの日常業務にセキュリティの仕事を組み込み、セキュリティを全員の職務にする。

- 全てのエンジニアが業務で利用しているJIRAに全てのセキュリティ問題を登録
- デプロイパイプラインに自動セキュリティテストを組み込む
...
- 変更承認プロセスの見直し
  - 変更のバッチサイズが大きくなるほど様々な問題に発展しやすい
  - 変更の承認が必要な組織なら、その変更の基準を見直す
    - 標準的な変更の方を多くしていくようにする
- 職務の分離に対する依存度を下げる
  - 昔ならいざ知らず、システムが複雑でデプロイの頻度が多い世の中
  - エンジニアが自分の仕事の結果を見れて、すぐにフィードバックを受けないといけない
    - コードレビュー
    - ペアプロ
    - そういった手法に切り替えるべき
...
その時の私は例に漏れず「意識高いなぁ・・・・そんな体制実現できるわけないだろ・・・」と思っていた。
...
または普段から素行をよくして、「こいつにならチャレンジさせてもよいか」という印象を持っておいてもらう必要もあるだろう
...
確かに日常業務で利用しているカンバンは運用の業務も含めて、どんどん作業が溜まっていく。
（TODO、進行中が特に多い）

今スプリント中にやる必要のないものも多く混ざっている。

プロダクトオーナーと含めてここを改善していく必要がある。
